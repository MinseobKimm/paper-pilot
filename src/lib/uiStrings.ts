...
export const uiStrings: Record<UiLanguage, UiStrings> = {
  ko: {
    ...
    more: "더보기",
    panel: "패널",
    openRightPanel: "오른쪽 패널 열기",
    closeRightPanel: "오른쪽 패널 닫기",
    working: "작업 중",
    settingsTitle: "설정",
    ...
    addReaderBookmark: "현재 위치 북마크",
    readerBookmarkSaved: "현재 확대율과 스크롤 위치를 북마크했습니다.",
    readerBookmarkDeleted: "북마크를 삭제했습니다.",
    readerBookmarks: "읽기 북마크",
    goToReaderBookmark: "북마크로 이동",
    deleteReaderBookmarkHint: "우클릭하면 삭제됩니다",
    noAuthors: "저자 정보 없음",
    unknownYear: "연도 -",
    pageSuffix: "쪽",
  ...
  en: {
    ...
    addReaderBookmark: "Bookmark current position",
    readerBookmarkSaved: "Bookmarked the current zoom and scroll position.",
    readerBookmarkDeleted: "Bookmark deleted.",
    readerBookmarks: "Reader bookmarks",
    goToReaderBookmark: "Go to bookmark",
    deleteReaderBookmarkHint: "Right-click to delete",
